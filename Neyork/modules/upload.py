...
from Neyork import telethn as bot
from Neyork.modules.urluploader import download_file
from Neyork.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *NeyorkRobot*",
            )
        except Exception as e:
            traceback.print_exc()
