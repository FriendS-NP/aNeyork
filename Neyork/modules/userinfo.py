...
from Neyork.__main__ import STATS, TOKEN, USER_INFO
from Neyork.modules.sql import SESSION
import Neyork.modules.sql.userinfo_sql as sql
from Neyork.modules.disable import DisableAbleCommandHandler
from Neyork.modules.sql.global_bans_sql import is_user_gbanned
from Neyork.modules.sql.afk_sql import is_afk, set_afk
from Neyork.modules.sql.users_sql import get_user_num_chats
from Neyork.modules.helper_funcs.chat_status import sudo_plus
from Neyork.modules.helper_funcs.extraction import extract_user
from Neyork import telethn
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        disaster_level_present = True
         ...
         text += "\n\nOwner Of A Bot. King Of @QDevQ. Bot Name Inspired From 'Neyork'."
         disaster_level_present = True
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/NeyorkUpdate/3"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/NeyorkUpdate/3")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Neyork Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
    result = re.sub(r"(\d+)", r"<code>\1</code>", stats)
    result += "\n<b>╘═━「 Powered By Neyork 」</b>"
    update.effective_message.reply_text(
        result,
        parse_mode=ParseMode.HTML, 
        disable_web_page_preview=True
