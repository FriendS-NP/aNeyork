...
from Neyork import pbot as app 
from Neyork import arq
from Neyork.services.keyboard import Ikb
from Neyork.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Neyork.services.tasks import _get_tasks_text, all_tasks, rm_task
from Neyork.services.types import InlineQueryResultCachedDocument
from Neyork.modules.info import get_chat_info, get_user_info
from Neyork.utils.functions import test_speedtest
from Neyork.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/d6668ed2144be07b180df.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Source1bot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Neyork Robot ❤️](https://t.me/Source1bot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [OWNER BOT](t.me/QDevQ)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
