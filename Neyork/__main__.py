...
import Neyork.modules.sql.users_sql as sql
...
from Neyork.modules import ALL_MODULES
from Neyork.modules.helper_funcs.chat_status import is_user_admin
from Neyork.modules.helper_funcs.misc import paginate_modules
...
SIESTA_IMG = "https://telegra.ph/file/d6668ed2144be07b180df.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @QDevQ \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Neyork.modules." + module_name)
                    ...
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                text=gs(chat.id, "add_bot_to_group_button"), url=f"t.me/{BOT_USERNAME}?startgroup=new"),
                        ]
                    ]
                ),
                parse_mode=ParseMode.MARKDOWN,
    ...
    if query.data == "siesta_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text=gs(chat.id, "source_button"), url="https://github.com/Neyork/aNeyork"),
                    ],
                    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=gs(chat.id, "support_chat_link_button"), url="t.me/NeyorkSupport"),
                        InlineKeyboardButton(text=gs(chat.id, "updates_channel_link_button"), url="https://t.me/NeyorkUpdate"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="siesta_"),
                    ]
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Neyork", url="https://t.me/QDevQ"),
                    ],
                    [
                        InlineKeyboardButton(text="About Neyork", url="https://t.me/aNeyork"),
                        InlineKeyboardButton(text="The Mab", url="https://t.me/QUserS"),
                    ],
                    [
                        InlineKeyboardButton(text=gs(chat.id, "back_button"), callback_data="siesta_"),
                    ]
